...
describe('Field test for requestControl', function(){
    ...
    it('Testing method generateRequest', function(){
        var input = ['Veronica', 'Volpicelli', '22/04/1996', '123456789', 'F', 'Italiana', '2nd Cycle', '19', '20', 'Informatica, 05121', 'v.volpicelli2@studenti.unisa.it', 'Informatica', 'Filomena Ferrucci',
    ...
    it('Testing method updateExternalTutor', function(){
        var input = ['v.volpicelli2@studenti.unisa.it', 'm.berto@gmail.com'];
